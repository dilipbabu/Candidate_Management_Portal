...
<html lang="en">
    ...
    <style>
    	header.masthead {
		  background: url(admin/assets/img/Candidate_Management_portal.jpg);
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Thank You ! Candidate Management Portal  </div></div>
        </footer>
